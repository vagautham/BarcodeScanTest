...
//      CGFloat width = isPortrait ? appRect.size.width : appRect.size.height;
//      CGFloat height = isPortrait ? appRect.size.height : appRect.size.width;
//      appRect = CGRectMake(0, 0, width, height);
//      NSLog(@"%@", NSStringFromCGRect(appRect));
      OverlayView *theOverLayView = [[OverlayView alloc] initWithFrame:appRect
